...
<template>  
<!--   <ais-search-box class="md:w-3/4 lg:w-1/2 mx-auto p-2" :class-names="{
    'ais-SearchBox-input': 'p-6 w-full rounded-lg border-2',
    'ais-SearchBox-submitIcon': 'hidden',
    'ais-SearchBox-resetIcon': 'hidden',
  }" type="text" name="search" placeholder="Hlodej šmudlo..." /> -->
  <ais-search-box class="md:w-3/4 lg:w-1/2 mx-auto p-2" type="text" name="search" placeholder="Hledejte České výrobky..." />
</template>